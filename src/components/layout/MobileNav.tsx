...
import { LayoutDashboard, Menu, X, Check, Pencil, Plus, Download, LogOut, Trash2 } from 'lucide-react'
          ...
          <div className="relative bg-white dark:bg-gray-900 rounded-t-3xl shadow-2xl overflow-y-auto"
            ...
            <div className="px-4 pt-3 pb-4 border-b border-gray-100 dark:border-gray-800">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs text-gray-400 leading-none mb-1">{formatDate(new Date())}</p>
                  {editingName ? (
                    <div className="flex gap-1.5 mt-0.5">
                      ...
                      <button onClick={saveUserName} className="w-8 h-8 rounded-xl bg-emerald-50 dark:bg-emerald-950 text-emerald-500 flex items-center justify-center shrink-0"><Check size={14} /></button>
                      <button onClick={() => setEditingName(false)} className="w-8 h-8 rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-400 flex items-center justify-center shrink-0"><X size={14} /></button>
                    </div>
                  ) : (
                ...
                <button onClick={close}
                  className="w-8 h-8 rounded-xl bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-400 shrink-0 mt-0.5">
                  <X size={16} />
                </button>
              </div>
            </div>
            ...
            <div className="px-4 py-3 border-b border-gray-100 dark:border-gray-800">
              <Link href="/import" onClick={close}
                ...
                <Download size={15} className="text-gray-400" /> Importa
              </Link>
              ...
              <div className="flex items-center gap-2.5 px-3 py-2.5">
                ...
                <button
                  ...
                  <span
                    ...
                    style={{ left: 4, transform: isDark ? 'translateX(20px)' : 'translateX(0)' }}
                  />
                </button>
              </div>
            </div>
