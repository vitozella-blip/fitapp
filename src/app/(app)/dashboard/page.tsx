  ...
  const icons: Record<string, React.ReactElement> = {
    colazione: (
      <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M3 11h18"/>
        <path d="M5 11c0 3 1 6 7 6s7-3 7-6"/>
        <path d="M8 7c0-1 .5-2 1.5-2.5"/>
      </svg>
    ),
    spuntino_m: (
      <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M8 3h8l1 5H7z"/>
    ...
    pranzo: (
      <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M7 16c1-1.5 2.5-2 5-2s4 .5 5 2"/>
        <path d="M12 8v1"/>
      </svg>
    ),
    spuntino_p: (
      <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 3c-1 0-2 .5-2.5 1.5"/>
        <path d="M6 9c0-3 2-6 6-6s6 3 6 6c0 4-2 9-6 9s-6-5-6-9z"/>
        <path d="M12 3c2-1 4 0 4 2"/>
      </svg>
    ),
    cena: (
      <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M6 9h12l-1 8H7z"/>
        <path d="M8 9V7c0-1 .5-2 2-2h4c1.5 0 2 1 2 2v2"/>
...
export default function DashboardPage() {
  ...
  return (
    /* Mobile: fixed height layout that fills screen without scroll
       Desktop: normal vertical flow */
    <div className="flex flex-col gap-2 max-w-2xl mx-auto md:max-w-none md:space-y-4
                    md:h-auto h-[calc(100dvh-7.5rem)]">
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl px-4 py-3">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-baseline gap-1.5">
              <span className={cn('text-2xl font-bold', calOver ? 'text-red-500' : '')}
                style={!calOver ? { color: '#6c5ce7' } : {}}>
                {t.calories}
              </span>
              <span className="text-xs text-gray-400">/ {tg.calories} kcal</span>
            </div>
            <span className={cn('text-xs font-bold px-2 py-1 rounded-lg', calOver
          ...
          <div className="h-2 bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden">
            <div className="h-full rounded-full transition-all"
              style={{ width: `${calPct}%`, backgroundColor: calOver ? '#ef4444' : '#6c5ce7' }} />
          </div>
        </div>
      ...
      {/* ── BOTTOM CARDS (side by side, fill remaining height) ── */}
